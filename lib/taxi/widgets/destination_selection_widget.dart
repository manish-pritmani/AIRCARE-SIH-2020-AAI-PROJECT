...
import 'package:sih/taxi/controllers/user_location_controller.dart';
import 'package:sih/taxi/models/user_location.dart';
import 'package:sih/taxi/widgets/ease_in_widget.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Icon(
                  location.locationType == UserLocationType.Airport
                      ? Icons.flight
                      : Icons.hotel,
                  size: 22.0,
