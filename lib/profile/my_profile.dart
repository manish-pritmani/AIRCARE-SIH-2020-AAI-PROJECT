...
//                                        image: new NetworkImage("https://www.optimalclinicaltrials.com/webpack/static/images/placeholder-avatar.75c68d41602912ccfa76c511e0b00d6a.png"),
                                        fit: BoxFit.cover,
                                      ),
                                    )),
                              ],
                            ...
                            Padding(
                                padding:
                                EdgeInsets.only(top: 80.0, right: 80.0),
                                child: new Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: <Widget>[
                                    new CircleAvatar(
...
//                                            fontWeight: FontWeight.bold
                          ...
                          Container(
                            margin: const EdgeInsets.fromLTRB(25, 15, 25, 00),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                Text(
