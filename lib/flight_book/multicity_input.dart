import 'package:sih/flight_book/typable_text.dart';
          ...
          children: <Widget>[
            Padding(
              ...
              child: TypeableTextFormField(
                ...
                decoration: InputDecoration(
                  icon: Icon(Icons.flight_takeoff, color: Color(0xff376AFF)),
                  labelText: "From",
                ),
              ),
            ),
            Padding(
              ...
              child: TypeableTextFormField(
                ...
                decoration: InputDecoration(
                  icon: Icon(Icons.flight_land, color: Color(0xff376AFF)),
                  labelText: "To",
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: TypeableTextFormField(
                ...
                finalText: "4",
                decoration: InputDecoration(
                  icon: Icon(Icons.person, color: Color(0xff376AFF)),
            ...
            Row(
              children: <Widget>[
                Padding(
                  ...
                  child: Icon(Icons.date_range, color: Color(0xff376AFF)),
                ),
                Expanded(
                  child: Padding(
                    padding: const EdgeInsets.only(right: 16.0),
